/**
 * Script para debuggear la función obtenerDatosSuscripcion directamente
 */
...
// Simular la función obtenerDatosSuscripcion
async function obtenerDatosSuscripcion(studioSlug) {
    console.log('🔍 Ejecutando obtenerDatosSuscripcion...');
    ...
    try {
        ...
        if (!userStudioRole) {
            ...
            console.log('   Roles disponibles:', allRoles.map(r => ({
...
async function debugFuncionSuscripcion() {
    console.log('🔍 Debuggeando función obtenerDatosSuscripcion...\n');
...
debugFuncionSuscripcion().catch(console.error);
