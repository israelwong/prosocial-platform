...
export function PlatformConfigDebug() {
    ...
    return (
        <div className={`fixed bottom-4 right-4 bg-black bg-opacity-90 text-white rounded-lg shadow-xl z-50 transition-all duration-300 ${
            ...
            {!isMinimized ? (
                <div className="p-4">
                    ...
                    <div className="space-y-2 text-xs max-h-64 overflow-y-auto">
                        <div className="grid grid-cols-2 gap-2">
                            <div className={`px-2 py-1 rounded text-center ${
                                loading ? 'bg-yellow-500 bg-opacity-30' : 'bg-green-500 bg-opacity-30'
                            }`}>
                                Loading: {loading ? 'true' : 'false'}
                            </div>
                            <div className={`px-2 py-1 rounded text-center ${
                                error ? 'bg-red-500 bg-opacity-30' : 'bg-green-500 bg-opacity-30'
                            }`}>
                        ...
                        <div className={`px-2 py-1 rounded text-center ${
                            config ? 'bg-green-500 bg-opacity-30' : 'bg-gray-500 bg-opacity-30'
                        }`}>
                    ...
                    <div className="mt-3 pt-2 border-t border-white border-opacity-20 text-xs text-gray-300">
                        ...
                        <div>• <kbd className="bg-gray-700 px-1 rounded">Click</kbd> Minimizar</div>
                    </div>
                </div>
            ) : (
                <button
