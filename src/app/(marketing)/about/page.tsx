        ...
        <div className="min-h-screen bg-zinc-900 text-white">
            ...
            <section className="relative py-20 px-4 bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900">
                <div className="container mx-auto max-w-4xl text-center">
                    <h1 className="text-5xl font-bold mb-6">Acerca de Zen Studio</h1>
                    <p className="text-xl text-gray-300 mb-8">
                        Revolucionando la gestión de estudios creativos
                    </p>
                    <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                        Zen Studio es la solución integral diseñada específicamente para fotógrafos,
                ...
                <div className="container mx-auto max-w-4xl">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-zinc-800 p-8 rounded-lg">
                            <h3 className="text-2xl font-bold mb-4">¿Por qué Zen Studio?</h3>
