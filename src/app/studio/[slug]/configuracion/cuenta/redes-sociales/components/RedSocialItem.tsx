        ...
        <>
            <div className={`p-3 bg-zinc-800 rounded-lg border transition-colors ${red.activo ? 'border-zinc-700' : 'border-zinc-800 opacity-60'}`}>
                <div className="flex items-center space-x-3">
                    ...
                    >
                        <RedSocialIcon
                            icono={plataformaInfo?.icono || 'default'}
            ...
            <ConfirmModal
                ...
                title="Eliminar red social"
                description={`¿Estás seguro de que quieres eliminar ${plataformaInfo?.nombre || 'esta red social'}? Esta acción no se puede deshacer.`}
