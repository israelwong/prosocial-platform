    ...
    const navigationItems: NavigationSection[] = [
        ...
        },
        {
            ...
            items: [
                ...
                { name: 'Condiciones Comerciales', href: `/studio/${slug}/configuracion/negocio/condiciones-comerciales`, icon: FileText },
                { name: 'Métodos de Pago', href: `/studio/${slug}/configuracion/negocio/metodos-pago`, icon: CreditCard },
